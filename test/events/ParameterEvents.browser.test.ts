  ...
  describe('StoreEvents.Parameter', () => {
    ...
    describe('getRecursive()', () => {
      ...
      it('dispatches the event', async () => {
        ...
        StoreEvents.Parameter.getRecursive(id, et);
        assert.isTrue(spy.calledOnce);
      });
      ...
      it('waits until resolved', async () => {
        ...
        const result = await StoreEvents.Parameter.getRecursive(id, et);
        assert.equal(result, data);
      });
    });
    ...
    describe('getBulkRecursive()', () => {
      ...
      it('dispatches the event', async () => {
        ...
        StoreEvents.Parameter.getBulkRecursive(ids, et);
        assert.isTrue(spy.calledOnce);
      });
      ...
      it('waits until resolved', async () => {
        ...
        const result = await StoreEvents.Parameter.getBulkRecursive(ids, et);
        assert.deepEqual(result, data);
      });
    });
